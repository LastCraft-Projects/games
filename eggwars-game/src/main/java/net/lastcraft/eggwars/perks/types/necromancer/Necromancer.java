package net.lastcraft.eggwars.perks.types.necromancer;
 ...
 */
public class Necromancer extends EWPerk {

    private final String name = "§eКолдун";

    public Necromancer(Rarity rarity, int cost) {
        super(rarity, cost);
    }
    ...
    public ItemStack getItem(Player player) {
        return ItemUtil.createItemStack(Material.GLASS_BOTTLE, name, Arrays.asList("§7При респавне эффекты", "§7зелий не пропадают"));
    }
